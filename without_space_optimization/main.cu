  ...
  if (myrank == 0)
    {
        ...
        cout<<"Number of fill-ins detected: "<<global_fill_in<<endl;
        cout<<"Maximum time reported among the processes: "<<max_time<<" ms"<<endl;
        cout<<"Minimum time reported among the processes: "<<min_time<<" ms"<<endl;
