...
__global__ void Assign_sources (int_t gpu_id,int_t N_gpu,
        int_t* source_d, 
        int_t N_src_group, int_t begin_group,int_t* pass_through_d,int_t* nz_row_U_d)
{
    ...
    while (thid < N_src_group)
    {
        ...
        pass_through_d[pos] = 0;             
                nz_row_U_d[pos]=0; // For supernodes
...
//int main(int args, char **argv)
{
    ...
    std::cout<<"Input: ./exe beg end csr Num_GPU Total_memory(6 data) max_supernode_size\n";
    ...
    if(args!=8){std::cout<<"Wrong input\n";exit(1);}
    ...
    int_t max_supernode_size = atoi(argv[6]);
    int_t N_GPU_Node = atoi(argv[7]);
